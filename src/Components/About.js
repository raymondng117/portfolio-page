            ...
            <div className='row align-items-center main-container'>
                ...
                <div className='d-flex col-md-8 col-12 p-3 flex-column about-content-column'>
                    <div>
                        ...
                        <p className='about-p'>
                            Now I'm recently graduated and looking for an intern or full-time <strong>web developer position</strong>. I'm eager to contribute my skills and be a valuable team member. If you'd like to get in touch, feel free to reach out!
                        </p>
                    </div>

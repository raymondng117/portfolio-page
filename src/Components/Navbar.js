...
const Navbar = () => {
    ...
    return (
        ...
        >
            <nav className={`navbar navbar-expand-lg navbar-light sticky-top${navbarVisible ? ' navbar-visible' : ''}`}  style={{ backgroundColor: '#028090' }} >
                <div className="container-fluid" style={{ backgroundColor: '#028090' }} >
                    {/* Brand */}
